...
export const MoodBoardNode = memo(({ data, selected }: NodeProps) => {
  ...
  // const fetchUrlMetadata = useAction(api.domains.shared.moodboardUtils.fetchUrlMetadata);
  ...
  const handleAddItem = async () => {
    ...
    try {
      ...
      // For now, just remove loading state since metadata fetching is not implemented
