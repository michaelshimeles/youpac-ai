...
export default function Page() {
  const projects = useQuery(api.domains.projects.projects.getProjects, { includeArchived: false });
  const profile = useQuery(api.domains.users.profiles.getUserProfile);
  const createProject = useMutation(api.domains.projects.projects.createProject);
  const archiveProject = useMutation(api.domains.projects.projects.updateProject);
  const deleteProject = useMutation(api.domains.projects.projects.deleteProject);
