...
import { SharedCanvas } from "~/features/canvas/components/SharedCanvas";
...
export async function loader({ params }: LoaderFunctionArgs) {
  ...
  try {
    const sharedData = await convex.query(api.domains.shared.shares.getSharedCanvas, { shareId });
...
export default function SharedCanvasPage() {
  ...
  const incrementViewCount = useMutation(api.domains.shared.shares.incrementViewCount);
